...
For edit distance, it looks like as follows. The first column of the output is edit distance and the second column is normalized edit distance.
...
The following shows examples of how to use it.
